...
/**
 * Owner / admin / agent (team members): create, sync, edit, and delete
 * WhatsApp message templates. Viewers are read-only.
 */
...
/**
 * Owner / admin / agent (team members): create and manage canned responses.
 */
export function canManageCannedResponses(role: AccountRole): boolean {
  return hasMinRole(role, "agent");
}
